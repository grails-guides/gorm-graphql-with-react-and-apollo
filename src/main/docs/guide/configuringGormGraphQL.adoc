...
----
include::{sourceDir}/grails-app/domain/gormgraphql/Talk.groovy[indent=0,tag=graphql]
----
...
----
include::{sourceDir}/grails-app/domain/gormgraphql/Speaker.groovy[indent=0,tag=graphql]
----
