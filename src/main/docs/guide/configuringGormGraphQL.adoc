...
.build.gradle
----
include::{sourceDir}/server/build.gradle[indent=0,tag=graphqldependency]
----
...
----
include::{sourceDir}/server/grails-app/domain/com/objectcomputing/Talk.groovy[indent=0]
----
...
----
include::{sourceDir}/server/grails-app/domain/com/objectcomputing/Speaker.groovy[indent=0]
----
